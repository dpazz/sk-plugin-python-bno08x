...
>by the Adafruit BNO08x library (it happens during calibration) and normally sent to stdout, respectively, during
>calibration at startup and during periodic calibration. This plugin redirects this tipe of output to those files
